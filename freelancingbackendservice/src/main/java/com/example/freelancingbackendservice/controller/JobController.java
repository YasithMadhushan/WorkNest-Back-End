...
import com.example.freelancingbackendservice.service.JobService;
...
public class JobController {
    ...
    @Autowired
    private com.example.freelancingbackendservice.service.NotificationService notificationService;

    @Autowired
    private com.example.freelancingbackendservice.repository.FreelancerRepository freelancerRepository;
    ...
    public ResponseEntity<?> getAllJobs(@RequestParam(required = false) Long freelancerId) {
        ...
        if (freelancerId != null) {
            try {
                com.example.freelancingbackendservice.entity.Freelancer freelancer = freelancerRepository.findById(freelancerId)
                        .orElse(null);

                if (freelancer != null) {
                    List<com.example.freelancingbackendservice.dto.JobDTO> jobDTOs = jobs.stream()
                            .map(job -> {
                                com.example.freelancingbackendservice.dto.JobDTO dto = new com.example.freelancingbackendservice.dto.JobDTO();
                                dto.setId(job.getId());
    ...
    public ResponseEntity<?> getJobById(@PathVariable Long id,
        ...
        return jobRepository.findById(id)
                .map(job -> {
                    ...
                    if (freelancerId != null) {
                        try {
                            com.example.freelancingbackendservice.entity.Freelancer freelancer = freelancerRepository
